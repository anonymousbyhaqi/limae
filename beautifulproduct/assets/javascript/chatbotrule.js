function getBotReply(message) {
  ...
  return "Maaf ya 🙏 aku belum paham pertanyaan itu.";
}
...
const chatbotRules = [
  ...
  },
  {
    ...
    response: "Untuk kulit berminyak dan berjerawat, kami rekomendasikan Facial Wash Tea Tree 🌿 yang membantu mengontrol minyak dan mencegah jerawat."
  },
  {
    keywords: ["kulit kering", "kering"],
    response: "Untuk kulit kering, Moisturizing Day Cream sangat cocok karena membantu menjaga kelembapan kulit sepanjang hari 💧"
  },
  {
    keywords: ["kulit sensitif", "sensitif"],
    response: "Jika Anda memiliki kulit sensitif, Gentle Facial Wash adalah pilihan aman karena formulanya lembut dan tidak menyebabkan iritasi 🤍"
  },
  {
    keywords: ["bpom", "aman"],
    response: "Tenang 😊 Semua produk BeautyCare telah terdaftar BPOM dan aman digunakan sesuai aturan pakai."
  },
  {
    keywords: ["cara pakai", "pemakaian"],
    response: "Cara pemakaian setiap produk tertera pada kemasan. Jika ingin, sebutkan nama produk dan saya akan jelaskan secara detail 💕"
  },
  {
    keywords: ["harga"],
    response: "Harga produk BeautyCare sangat terjangkau 💖 Silakan sebutkan nama produk yang ingin Anda ketahui."
  },
  {
  ...
  },
  {
    ...
    response: "Harga Acne Spot Treatment adalah Rp45.000 🌿"
  },
  {
    keywords: ["day cream", "moisturizing cream", "moisturizing day cream"],
    response: "Harga Moisturizing Day Cream adalah Rp70.000 💧"
  },
  {
